...
from accounts.models import User_Groups, User, Group, Group_Permission
...
class EmployeeSerializer(serializers.ModelSerializer):
     ...
     class Meta:
         ...
         def get_groups(self, obj):
            groupDB = User_Groups.objects.filter(user_id=obj.user.id).all()
            groupDATA= []
...
class TasksSerrializer(serializers.ModelSerializer):
