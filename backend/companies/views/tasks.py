...
from companies.serializers import TaskSerializer,  TasksSerrializer
...
class Tasks(Base):
    ...
    def get(self, request):
        ...
        serializer = TasksSerrializer(tasks, many=True)
        ...
        if due_date:
           try:
              due_date = datetime.datetime.strptime(due_date, "%d,%m,%Y %H:%M")
               ...
               raise APIException("A data deve ser padrão: d/m/Y  H:M ", "date_invalid")
